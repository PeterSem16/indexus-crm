...
- **Lead Search System**: 9-step systematic pipeline: (1) AI Query Builder - 20 targeted queries in local language, (2) Discovery - DuckDuckGo + Bing multi-wave search with adaptive retry, (3) Fetch - systematic scraping of 30+ pages, (4) Deep Crawl - follow internal links on directory pages, (5) Contact Page Follow - /kontakt, /about, /team subpages, (6) AI Extraction - GPT-4o-mini structured extraction with second pass, (7) Deduplication - domain/email/phone/name merging, (8) Scoring - quality score (email+20, phone+15, address+10, etc.), (9) Save. Features: AI-suggested search criteria with multi-select/combine, duplicate detection against existing records, field-level diff/update, preview dialog. Tables: `search_jobs`, `search_results`. Endpoint: `/api/lead-search/ai-suggest`.
