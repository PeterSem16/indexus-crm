...
- **Lead Intelligence System**: Multi-feature lead generation platform with 4 sub-tabs (Dashboard, Search, Sources, Campaigns). **Search Pipeline** (10 steps): (1) AI Query Builder, (2) Discovery (DDG+Bing), (3) Fetch/Parse, (4) Deep Crawl directories, (5) Contact Page Follow, (6) AI Extraction (GPT-4o-mini with 2nd pass), (6b) AI Enrichment (website scraping for extra data, IČO lookup from finstat.sk/ARES for SK/CZ, SSRF-protected), (7) Deduplication, (8) Scoring, (9) Save, (10) Auto-track source domains. **Source Management**: CRUD for lead sources (directories, registries) with whitelist/blacklist, auto-discovery from search results, success/fail tracking. Tables: `lead_sources`. **Automated Campaigns**: Scheduled recurring searches (daily/weekly/monthly) with admin notifications, mutex-protected scheduler. Tables: `lead_campaigns`. **Lead Dashboard**: Analytics endpoint with stats cards, country/segment/confidence breakdowns, top 10 sources, 30-day timeline chart. Endpoints: `/api/lead-sources`, `/api/lead-campaigns`, `/api/lead-search/analytics`. Also: AI-suggested search criteria with multi-select/combine, duplicate detection, field-level diff/update.
