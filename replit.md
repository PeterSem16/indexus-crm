...
- **Call Center Agent Workspace**: Dedicated 3-column layout for call center operators with queue management (including scheduled queue), integrated SIP phone, contact cards, modern script viewer, campaign scripts, email/SMS composer (connected to MS365/BulkGate APIs), disposition tracking, persistent communication history with AI-powered sentiment analysis, and FAQ system.
