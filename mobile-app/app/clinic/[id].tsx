...
const styles = StyleSheet.create({
  ...
  actionBtnOutline: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: Spacing.md, gap: 6, borderWidth: 1, borderColor: '#10b981', borderRadius: 12, backgroundColor: Colors.white, height: '100%' },
