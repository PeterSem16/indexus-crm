...
type TranslationKeys = {
  ...
  profile: {
    ...
    callForwardingTitle: string;
    callForwardingLabel: string;
    callForwardingDesc: string;
    callForwardingPlaceholder: string;
    callForwardingSave: string;
    forwardingSaved: string;
  ...
  reports: {
    ...
    hospitalActivityReport: string;
    workHoursReport: string;
    callHistoryReport: string;
  };
};
...
const translations: Record<SupportedLanguage, TranslationKeys> = {
  sk: {
    ...
    hospitals: {
      ...
      doctorLabel: 'Lekar',
      callAction: 'Zavolat',
      navigateAction: 'Navigovat',
      recordsCount: 'zaznamov',
      additionalInfo: 'Dalsie udaje',
      active: 'Aktivna',
      yes: 'Ano',
      no: 'Nie',
      ...
      clinicNotFound: 'Ambulancia nenajdena',
      saveChanges: 'Ulozit zmeny',
      editAction: 'Upravit',
      saved: 'Ulozene',
      saveSuccess: 'Zmeny boli uspesne ulozene.',
      saveError: 'Nepodarilo sa ulozit',
      streetLabel: 'Ulica',
      notSet: 'Nezadany',
      doctorSection: 'Lekar',
      openWebsite: 'Otvorit web',
      flyersLabel: 'Letaky',
      hasFlyers: 'Ma letaky',
      sendEmailAction: 'Napisat email',
    },
    map: {
      title: 'Mapa',
    ...
    profile: {
      ...
      callForwardingTitle: 'Presmerovanie hovorov',
      callForwardingLabel: 'Presmerovat hovory na mobil',
      callForwardingDesc: 'Prichadzajuce hovory z fronty budu presmerovane na mobilne cislo',
      callForwardingPlaceholder: '+421900123456',
      callForwardingSave: 'Ulozit presmerovanie',
      forwardingSaved: 'Presmerovanie ulozene',
      forwardingError: 'Nepodarilo sa ulozit presmerovanie',
    ...
    reports: {
      ...
      loadingStats: 'Nacitavam statistiky...',
      visitsLabel: 'Navstevy',
      completedOf: 'splnenych',
      hospitalsLabel: 'Nemocnice',
      uniqueLabel: 'unikatnych',
      workHoursLabel: 'Prac. hodiny',
      daysLabel: 'dni',
      callTimeLabel: 'Cas hovorov',
      callsLabel: 'hovorov',
      visitBreakdown: 'Rozdelenie navstev',
      completedVisits: 'Splnene',
      plannedVisits: 'Planovane',
      cancelledVisits: 'Zrusene',
      topHospitals: 'Top nemocnice',
      downloadCsv: 'Stiahnut CSV report',
      visitSummaryReport: 'Suhrn navstev',
      hospitalActivityReport: 'Aktivita nemocnic',
      workHoursReport: 'Pracovne hodiny',
      callHistoryReport: 'Historia hovorov',
    },
  },
  cs: {
    common: {
    ...
    hospitals: {
      ...
      callAction: 'Zavolat',
      navigateAction: 'Navigovat',
      recordsCount: 'zaznamu',
      additionalInfo: 'Dalsi udaje',
      active: 'Aktivni',
      yes: 'Ano',
      no: 'Ne',
      personnelTab: 'Personal',
      ...
      clinicNotFound: 'Ambulance nenalezena',
      saveChanges: 'Ulozit zmeny',
      editAction: 'Upravit',
      saved: 'Ulozeno',
      saveSuccess: 'Zmeny byly uspesne ulozeny.',
      saveError: 'Nepodarilo se ulozit',
      streetLabel: 'Ulice',
      notSet: 'Nezadano',
      doctorSection: 'Lekar',
    ...
    profile: {
      ...
      callForwardingTitle: 'Presmerovani hovoru',
      callForwardingLabel: 'Presmerovat hovory na mobil',
      callForwardingDesc: 'Prichozi hovory z fronty budou presmerovany na mobilni cislo',
      callForwardingPlaceholder: '+420900123456',
      callForwardingSave: 'Ulozit presmerovani',
      forwardingSaved: 'Presmerovani ulozeno',
      forwardingError: 'Nepodarilo se ulozit presmerovani',
    ...
    reports: {
      ...
      completedOf: 'splnenych',
      hospitalsLabel: 'Nemocnice',
      uniqueLabel: 'unikalnych',
      workHoursLabel: 'Prac. hodiny',
      daysLabel: 'dni',
      callTimeLabel: 'Cas hovoru',
      callsLabel: 'hovoru',
      visitBreakdown: 'Rozdeleni navstev',
      completedVisits: 'Splnene',
      plannedVisits: 'Planovane',
      cancelledVisits: 'Zrusene',
      topHospitals: 'Top nemocnice',
      downloadCsv: 'Stahnout CSV report',
      visitSummaryReport: 'Souhrn navstev',
      hospitalActivityReport: 'Aktivita nemocnic',
      workHoursReport: 'Pracovni hodiny',
      callHistoryReport: 'Historie hovoru',
    },
  },
  hu: {
    common: {
    ...
    hospitals: {
      ...
      doctorLabel: 'Orvos',
      callAction: 'Hivas',
      navigateAction: 'Navigacio',
      recordsCount: 'rekord',
      additionalInfo: 'Egyeb adatok',
      active: 'Aktiv',
      yes: 'Igen',
      no: 'Nem',
      ...
      clinicNotFound: 'Rendelo nem talalhato',
      saveChanges: 'Valtoztatasok mentese',
      editAction: 'Szerkesztes',
      saved: 'Mentve',
      saveSuccess: 'A valtoztatasok sikeresen mentve.',
      saveError: 'Mentes sikertelen',
      streetLabel: 'Utca',
      notSet: 'Nincs megadva',
      doctorSection: 'Orvos',
      openWebsite: 'Web megnyitasa',
      flyersLabel: 'Prospektusok',
      hasFlyers: 'Van prospektusa',
      sendEmailAction: 'Email kuldes',
    },
    map: {
      title: 'Terkep',
    ...
    profile: {
      ...
      callForwardingTitle: 'Hivasatiranyitas',
      callForwardingLabel: 'Hivas atiranyitasa mobilra',
      callForwardingDesc: 'A varolistarol erkezo hivasok atiranyitodnak a mobilszamra',
      callForwardingPlaceholder: '+36900123456',
      callForwardingSave: 'Atiranyitas mentese',
      forwardingSaved: 'Hivasatiranyitas mentve',
      forwardingError: 'Az atiranyitas mentese sikertelen',
    ...
    reports: {
      ...
      loadingStats: 'Statisztikak betoltese...',
      visitsLabel: 'Latogatasok',
      completedOf: 'teljesitett',
      hospitalsLabel: 'Korhazak',
      uniqueLabel: 'egyedi',
      workHoursLabel: 'Munk. orak',
      daysLabel: 'nap',
      callTimeLabel: 'Hivas ido',
      callsLabel: 'hivas',
      visitBreakdown: 'Latogatasok elosztasa',
      completedVisits: 'Teljesitett',
      plannedVisits: 'Tervezett',
      cancelledVisits: 'Torolt',
      topHospitals: 'Top korhazak',
      downloadCsv: 'CSV report letoltese',
      visitSummaryReport: 'Latogatas osszefoglalo',
      hospitalActivityReport: 'Korhaz aktivitas',
      workHoursReport: 'Munkaidő',
      callHistoryReport: 'Hivas elozmenyek',
    },
  },
  de: {
    common: {
    ...
    hospitals: {
      ...
      doctorLabel: 'Arzt',
      callAction: 'Anrufen',
      navigateAction: 'Navigieren',
      recordsCount: 'Eintraege',
      additionalInfo: 'Weitere Daten',
      active: 'Aktiv',
      yes: 'Ja',
      no: 'Nein',
      personnelTab: 'Personal',
      ...
      clinicNotFound: 'Ambulanz nicht gefunden',
      saveChanges: 'Anderungen speichern',
      editAction: 'Bearbeiten',
      saved: 'Gespeichert',
      saveSuccess: 'Anderungen wurden gespeichert.',
      ...
      flyersLabel: 'Flyer',
      hasFlyers: 'Hat Flyer',
      sendEmailAction: 'Email schreiben',
    },
    map: {
      title: 'Karte',
    ...
    profile: {
      ...
      callForwardingTitle: 'Anrufweiterleitung',
      callForwardingLabel: 'Anrufe an Mobilnummer weiterleiten',
      callForwardingDesc: 'Eingehende Anrufe aus der Warteschlange werden an die Mobilnummer weitergeleitet',
      callForwardingPlaceholder: '+49900123456',
      callForwardingSave: 'Weiterleitung speichern',
      forwardingSaved: 'Weiterleitung gespeichert',
      forwardingError: 'Weiterleitung konnte nicht gespeichert werden',
    ...
    reports: {
      ...
      visitsLabel: 'Besuche',
      completedOf: 'erfuellt',
      hospitalsLabel: 'Krankenhauser',
      uniqueLabel: 'einmalig',
      workHoursLabel: 'Arb. Std.',
      daysLabel: 'Tage',
      callTimeLabel: 'Gespraeche',
      callsLabel: 'Anrufe',
      visitBreakdown: 'Besuchsverteilung',
      completedVisits: 'Erledigt',
      plannedVisits: 'Geplant',
      cancelledVisits: 'Abgesagt',
      topHospitals: 'Top Krankenhauser',
      downloadCsv: 'CSV Report herunterladen',
      visitSummaryReport: 'Besuchsubersicht',
      hospitalActivityReport: 'Krankenhausaktivitat',
      workHoursReport: 'Arbeitsstunden',
      callHistoryReport: 'Anrufverlauf',
    },
  },
  it: {
    common: {
    ...
    hospitals: {
      ...
      doctorLabel: 'Medico',
      callAction: 'Chiama',
      navigateAction: 'Naviga',
      recordsCount: 'voci',
      additionalInfo: 'Ulteriori dati',
      active: 'Attivo',
      yes: 'Si',
      no: 'No',
      ...
      clinicNotFound: 'Clinica non trovata',
      ...
      doctorSection: 'Medico',
      openWebsite: 'Apri sito web',
      flyersLabel: 'Volantini',
      hasFlyers: 'Ha volantini',
      sendEmailAction: 'Invia email',
    },
    map: {
      title: 'Mappa',
    ...
    profile: {
      ...
      callForwardingTitle: 'Inoltro chiamate',
      callForwardingLabel: 'Inoltra chiamate al cellulare',
      callForwardingDesc: 'Le chiamate in arrivo dalla coda verranno inoltrate al numero mobile',
      callForwardingPlaceholder: '+39900123456',
      callForwardingSave: 'Salva inoltro',
      forwardingSaved: 'Inoltro salvato',
      forwardingError: 'Impossibile salvare l\'inoltro',
    ...
    reports: {
      ...
      visitsLabel: 'Visite',
      completedOf: 'completate',
      hospitalsLabel: 'Ospedali',
      uniqueLabel: 'unici',
      workHoursLabel: 'Ore lav.',
      daysLabel: 'giorni',
      callTimeLabel: 'Tempo chiam.',
      callsLabel: 'chiamate',
      visitBreakdown: 'Distribuzione visite',
      completedVisits: 'Completate',
      plannedVisits: 'Pianificate',
      cancelledVisits: 'Annullate',
      topHospitals: 'Top ospedali',
      downloadCsv: 'Scarica report CSV',
      visitSummaryReport: 'Riepilogo visite',
      hospitalActivityReport: 'Attivita ospedali',
      workHoursReport: 'Ore lavorate',
      callHistoryReport: 'Cronologia chiamate',
    },
  },
  ro: {
    common: {
    ...
    hospitals: {
      ...
      doctorLabel: 'Medic',
      callAction: 'Suna',
      navigateAction: 'Navigheaza',
      recordsCount: 'inregistrari',
      additionalInfo: 'Date suplimentare',
      active: 'Activ',
      yes: 'Da',
      no: 'Nu',
      personnelTab: 'Personal',
      ...
      clinicNotFound: 'Cabinet negasit',
      saveChanges: 'Salveaza modificarile',
      editAction: 'Editare',
      saved: 'Salvat',
      saveSuccess: 'Modificarile au fost salvate.',
      saveError: 'Salvare esuata',
      streetLabel: 'Strada',
      notSet: 'Nespecificat',
      doctorSection: 'Medic',
      openWebsite: 'Deschide site',
      flyersLabel: 'Pliante',
      hasFlyers: 'Are pliante',
    ...
    profile: {
      ...
      callForwardingTitle: 'Redirectionare apeluri',
      callForwardingLabel: 'Redirectioneaza apeluri la mobil',
      callForwardingDesc: 'Apelurile primite din coada vor fi redirectionate la numarul de mobil',
      callForwardingPlaceholder: '+40900123456',
      callForwardingSave: 'Salvare redirectionare',
      forwardingSaved: 'Redirectionare salvata',
      forwardingError: 'Nu s-a putut salva redirectionarea',
    ...
    reports: {
      ...
      loadingStats: 'Se incarca statisticile...',
      visitsLabel: 'Vizite',
      completedOf: 'finalizate',
      hospitalsLabel: 'Spitale',
      uniqueLabel: 'unice',
      workHoursLabel: 'Ore lucrate',
      daysLabel: 'zile',
      callTimeLabel: 'Timp apeluri',
      callsLabel: 'apeluri',
      visitBreakdown: 'Distributia vizitelor',
      completedVisits: 'Finalizate',
      plannedVisits: 'Planificate',
      cancelledVisits: 'Anulate',
      topHospitals: 'Top spitale',
      downloadCsv: 'Descarca raport CSV',
      visitSummaryReport: 'Rezumat vizite',
      hospitalActivityReport: 'Activitate spitale',
      workHoursReport: 'Ore lucrate',
      callHistoryReport: 'Istoric apeluri',
    },
  },
  en: {
    common: {
    ...
    profile: {
      ...
      callForwardingTitle: 'Call Forwarding',
      callForwardingLabel: 'Forward calls to mobile',
      callForwardingDesc: 'Incoming queue calls will be forwarded to the mobile number',
      callForwardingPlaceholder: '+421900123456',
      callForwardingSave: 'Save forwarding',
      forwardingSaved: 'Forwarding saved',
      forwardingError: 'Failed to save call forwarding',
    ...
    reports: {
      ...
      visitSummaryReport: 'Visit summary',
      hospitalActivityReport: 'Hospital activity',
      workHoursReport: 'Working hours',
      callHistoryReport: 'Call history',
    },
  },
};
