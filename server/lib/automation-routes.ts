  ...
  app.get("/api/automation/catalog", requireAuth, async (_req, res) => {
    res.json({
      ...
      eventTypes: [
        ...
        { value: "schedule.tick", label: "Scheduled tick (recurring)" },
      ...
      fields: {
        ...
        task: [
          ...
          { value: "newValues.relatedEntityType", label: "Related entity type", type: "string" },
          { value: "newValues.relatedEntityId", label: "Related entity ID", type: "string" },
          { value: "newValues.country", label: "Country", type: "string" },
          { value: "newValues.dueDate", label: "Due date", type: "date" },
        ],
        contract: [
          { value: "newValues.status", label: "Status", type: "enum", options: ["draft", "pending_signature", "signed", "active", "completed", "cancelled", "expired"] },
          { value: "newValues.contractNumber", label: "Contract number", type: "string" },
          { value: "newValues.customerId", label: "Customer", type: "string" },
          { value: "newValues.billingDetailsId", label: "Billing details", type: "string" },
          { value: "newValues.currency", label: "Currency", type: "string" },
          { value: "newValues.country", label: "Country", type: "string" },
        ],
        hospital: [
          ...
          { value: "newValues.responsiblePersonId", label: "Responsible person", type: "string" },
        ...
        clinic: [
          ...
          { value: "newValues.lastCallResult", label: "Last call result", type: "string" },
          { value: "newValues.nextContactDate", label: "Next contact date", type: "date" },
          { value: "newValues.countryCode", label: "Country", type: "string" },
        ],
        invoice: [
          { value: "newValues.invoiceNumber", label: "Invoice number", type: "string" },
          { value: "newValues.status", label: "Status", type: "enum", options: ["pending", "sent", "paid", "overdue", "cancelled"] },
          { value: "newValues.totalAmount", label: "Total amount", type: "number" },
          { value: "newValues.paidAmount", label: "Paid amount", type: "number" },
          { value: "newValues.currency", label: "Currency", type: "string" },
          { value: "newValues.customerId", label: "Customer", type: "string" },
          { value: "newValues.dueDate", label: "Due date", type: "date" },
          { value: "newValues.sendDate", label: "Send date", type: "date" },
        ],
        call: [
          { value: "newValues.callId", label: "Call ID", type: "string" },
          { value: "newValues.callerNumber", label: "Caller number", type: "string" },
          { value: "newValues.calledNumber", label: "Called number", type: "string" },
          { value: "newValues.assignedAgentId", label: "Assigned agent", type: "string" },
          { value: "newValues.queueName", label: "Queue", type: "string" },
          { value: "newValues.durationSeconds", label: "Duration (s)", type: "number" },
          { value: "newValues.country", label: "Country", type: "string" },
        ],
      },
      countries: [
