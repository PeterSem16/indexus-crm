...
echo "  - CBU Report Viewer: OTP autorizácia, audit trail, grafické výsledky"
echo "  - CBU Report: AI analýza výsledkov, uloženie do lab results"
echo "  - Odbery: nový list view s pagináciou, vyhľadávaním, triedením"
echo "  - Odbery: pastelové grafy, redizajn progress baru a hlavičky formulára"
echo "  - Laboratóriá: LAB API integrácia s apiUrl a apiKey"
