...
interface NexusSidebarProps {
  ...
  teamsSidebarFilter?: "all" | "activity" | "channels" | "chats" | "meetings" | "calendar";
          ...
          {activeTab === "teams" && teamsSidebarFilter !== undefined && onTeamsSidebarFilterChange && (
            <>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    onClick={() => onTeamsSidebarFilterChange("calendar")}
                    className={`p-2 rounded-md transition-all ${teamsSidebarFilter === "calendar" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-foreground hover:bg-accent/50"}`}
                    data-testid="teams-collapsed-calendar"
                  >
                    <CalendarDays className="h-5 w-5 text-rose-500" />
                  </button>
                </TooltipTrigger>
                <TooltipContent side="right" className="text-xs">{t.nexusOmni.tabs.calendar}</TooltipContent>
              </Tooltip>
            </>
          )}
          ...
          {activeTab === "teams" && teamsSidebarFilter !== undefined && onTeamsSidebarFilterChange && (
            <>
              ...
              <SidebarItem
                ...
                label={t.nexusOmni.tabs.calendar}
                active={teamsSidebarFilter === "calendar"}
                onClick={() => onTeamsSidebarFilterChange("calendar")}
                small
                testId="teams-sidebar-calendar"
              />
            </>
          )}
        </div>
