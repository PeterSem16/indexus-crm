...
const priorityCityCopy: Record<Locale, {
  ...
  newReferrals: string;
  allCities: string;
  onlySelectedCities: string;
  citySelectionHint: string;
  noSelectedCities: string;
  referralCitiesPreset: string;
  citySearch: string;
  selectAllCities: string;
  clearCitySelection: string;
  citiesSelected: string;
  noCityMatches: string;
}> = {
  en: { groupByCity: "Group by city", groupByCityHint: "Rank eligible cities with AI before saving this view.", cityRankingPending: "Ranking cities…", cityRankingReady: "AI city order ready", cityRankingError: "City ranking failed.", cityRankingRetry: "Retry ranking", cityRankingRefresh: "Refresh ranking", cityRankingEstimated: "Estimated order", cityRankingLocations: "locations", cityRankingTooMany: "There are too many locations to rank.", unknownCity: "Unknown location", cityCountrySeparator: ", ", newReferrals: "New referrals", allCities: "All cities", onlySelectedCities: "Only selected cities", citySelectionHint: "Choose which eligible city locations stay in this view.", noSelectedCities: "No cities selected.", referralCitiesPreset: "Referral + cities", citySearch: "Search cities", selectAllCities: "Select all cities", clearCitySelection: "Clear selection", citiesSelected: "Selected", noCityMatches: "No matching cities" },
  sk: { groupByCity: "Zoskupiť podľa mesta", groupByCityHint: "Pred uložením zobrazenia zoradí oprávnené mestá AI.", cityRankingPending: "Zoraďujú sa mestá…", cityRankingReady: "Poradie miest AI je pripravené", cityRankingError: "Poradie miest zlyhalo.", cityRankingRetry: "Zopakovať poradie", cityRankingRefresh: "Obnoviť poradie", cityRankingEstimated: "Odhadované poradie", cityRankingLocations: "lokalít", cityRankingTooMany: "Na zoradenie je príliš veľa lokalít.", unknownCity: "Neznáma lokalita", cityCountrySeparator: ", ", newReferrals: "Nové odporúčania", allCities: "Všetky mestá", onlySelectedCities: "Iba vybrané mestá", citySelectionHint: "Vyberte oprávnené mestá, ktoré zostanú v tomto zobrazení.", noSelectedCities: "Nie sú vybrané žiadne mestá.", referralCitiesPreset: "Odporúčania + mestá", citySearch: "Hľadať mestá", selectAllCities: "Vybrať všetky mestá", clearCitySelection: "Zrušiť výber", citiesSelected: "Vybrané", noCityMatches: "Žiadne zodpovedajúce mestá" },
  cs: { groupByCity: "Seskupit podle města", groupByCityHint: "Před uložením zobrazení seřadí způsobilá města AI.", cityRankingPending: "Řazení měst…", cityRankingReady: "Pořadí měst AI je připraveno", cityRankingError: "Řazení měst selhalo.", cityRankingRetry: "Řadit znovu", cityRankingRefresh: "Obnovit pořadí", cityRankingEstimated: "Odhadované pořadí", cityRankingLocations: "lokalit", cityRankingTooMany: "K seřazení je příliš mnoho lokalit.", unknownCity: "Neznámá lokalita", cityCountrySeparator: ", ", newReferrals: "Nová doporučení", allCities: "Všechna města", onlySelectedCities: "Pouze vybraná města", citySelectionHint: "Vyberte způsobilá města, která zůstanou v tomto zobrazení.", noSelectedCities: "Nejsou vybrána žádná města.", referralCitiesPreset: "Doporučení + města", citySearch: "Hledat města", selectAllCities: "Vybrat všechna města", clearCitySelection: "Zrušit výběr", citiesSelected: "Vybráno", noCityMatches: "Žádná odpovídající města" },
  hu: { groupByCity: "Csoportosítás város szerint", groupByCityHint: "A nézet mentése előtt az AI sorba rendezi a jogosult városokat.", cityRankingPending: "Városok rangsorolása…", cityRankingReady: "Az AI városi sorrend kész", cityRankingError: "A városi rangsorolás sikertelen.", cityRankingRetry: "Rangsorolás újra", cityRankingRefresh: "Sorrend frissítése", cityRankingEstimated: "Becsült sorrend", cityRankingLocations: "helyszín", cityRankingTooMany: "Túl sok helyszín rangsorolható.", unknownCity: "Ismeretlen hely", cityCountrySeparator: ", ", newReferrals: "Új ajánlások", allCities: "Minden város", onlySelectedCities: "Csak a kiválasztott városok", citySelectionHint: "Válassza ki, mely jogosult városok maradjanak ebben a nézetben.", noSelectedCities: "Nincs kiválasztott város.", referralCitiesPreset: "Ajánlások + városok", citySearch: "Városok keresése", selectAllCities: "Összes város kijelölése", clearCitySelection: "Kijelölés törlése", citiesSelected: "Kiválasztva", noCityMatches: "Nincs egyező város" },
  ro: { groupByCity: "Grupează după oraș", groupByCityHint: "AI ordonează orașele eligibile înainte de salvarea vizualizării.", cityRankingPending: "Se ordonează orașele…", cityRankingReady: "Ordinea orașelor AI este gata", cityRankingError: "Ordonarea orașelor a eșuat.", cityRankingRetry: "Reîncearcă ordonarea", cityRankingRefresh: "Reîmprospătează ordinea", cityRankingEstimated: "Ordine estimată", cityRankingLocations: "locații", cityRankingTooMany: "Sunt prea multe locații pentru ordonare.", unknownCity: "Locație necunoscută", cityCountrySeparator: ", ", newReferrals: "Recomandări noi", allCities: "Toate orașele", onlySelectedCities: "Doar orașele selectate", citySelectionHint: "Alegeți orașele eligibile care rămân în această vizualizare.", noSelectedCities: "Nu este selectat niciun oraș.", referralCitiesPreset: "Recomandări + orașe", citySearch: "Caută orașe", selectAllCities: "Selectează toate orașele", clearCitySelection: "Șterge selecția", citiesSelected: "Selectate", noCityMatches: "Niciun oraș găsit" },
  it: { groupByCity: "Raggruppa per città", groupByCityHint: "L'AI ordina le città idonee prima di salvare questa vista.", cityRankingPending: "Città in classificazione…", cityRankingReady: "Ordine città AI pronto", cityRankingError: "Classificazione città non riuscita.", cityRankingRetry: "Riprova classificazione", cityRankingRefresh: "Aggiorna ordine", cityRankingEstimated: "Ordine stimato", cityRankingLocations: "località", cityRankingTooMany: "Troppe località da classificare.", unknownCity: "Località sconosciuta", cityCountrySeparator: ", ", newReferrals: "Nuovi referral", allCities: "Tutte le città", onlySelectedCities: "Solo città selezionate", citySelectionHint: "Scegli quali città idonee mantenere in questa vista.", noSelectedCities: "Nessuna città selezionata.", referralCitiesPreset: "Referral + città", citySearch: "Cerca città", selectAllCities: "Seleziona tutte le città", clearCitySelection: "Cancella selezione", citiesSelected: "Selezionate", noCityMatches: "Nessuna città corrispondente" },
  de: { groupByCity: "Nach Stadt gruppieren", groupByCityHint: "Die KI ordnet berechtigte Städte vor dem Speichern dieser Ansicht.", cityRankingPending: "Städte werden geordnet…", cityRankingReady: "KI-Städtereihenfolge bereit", cityRankingError: "Städterangfolge fehlgeschlagen.", cityRankingRetry: "Rangfolge wiederholen", cityRankingRefresh: "Rangfolge aktualisieren", cityRankingEstimated: "Geschätzte Reihenfolge", cityRankingLocations: "Orte", cityRankingTooMany: "Zu viele Orte für eine Rangfolge.", unknownCity: "Unbekannter Ort", cityCountrySeparator: ", ", newReferrals: "Neue Empfehlungen", allCities: "Alle Städte", onlySelectedCities: "Nur ausgewählte Städte", citySelectionHint: "Wählen Sie die berechtigten Städte für diese Ansicht.", noSelectedCities: "Keine Städte ausgewählt.", referralCitiesPreset: "Empfehlungen + Städte", citySearch: "Städte suchen", selectAllCities: "Alle Städte auswählen", clearCitySelection: "Auswahl aufheben", citiesSelected: "Ausgewählt", noCityMatches: "Keine passenden Städte" },
};
