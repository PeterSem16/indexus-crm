...
const ACTION_CONFIG: Record<string, { color: string; bgColor: string; label: string }> = {
  ...
  sent: { color: "#F59E0B", bgColor: "#FFFBEB", label: "Contract Sent" },
  viewed: { color: "#6366F1", bgColor: "#EEF2FF", label: "Contract Viewed" },
  otp_sent: { color: "#F97316", bgColor: "#FFF7ED", label: "OTP Code Sent" },
  otp_verified: { color: "#10B981", bgColor: "#ECFDF5", label: "OTP Verified" },
  ...
  audit_exported: { color: "#6B7280", bgColor: "#F9FAFB", label: "Audit Exported" },
